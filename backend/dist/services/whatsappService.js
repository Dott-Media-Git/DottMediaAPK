...
const FALLBACK_REPLY = 'Thanks for messaging Dott Media. We have received this and will get back to you shortly.';
export class WhatsAppService {
    constructor() {
        this.conversations = new ConversationService();
        this.messenger = new OutboundMessenger();
    }
    async handleMessages(messages, profileName, recipientId) {
        const results = [];
