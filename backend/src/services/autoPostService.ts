...
export class AutoPostService {
  ...
  private buildVideoCaptionFromHighlight(rawText: string, username: string, timezone: string) {
    ...
    return [
      ...
      'More football updates: www.bwinbetug.com',
    ]
      .filter(Boolean)
      .join('\n');
  }
      ...
      if (selectedContentType === 'prediction') {
        ...
        if (picks.length) {
          ...
          caption = [
            ...
            picksLine,
            'For full markets and live odds: www.bwinbetug.com',
          ]
            .filter(Boolean)
            .join('\n');
      ...
      if (selectedContentType === 'table') {
        ...
        if (snapshot?.rows?.length) {
          ...
          caption = [
            ...
            `Updated: ${updatedStamp} (${scheduleTimezone})`,
            ...rows,
            'For full tables and fixtures: www.bwinbetug.com',
          ]
            .filter(Boolean)
            .join('\n');
          const key = this.buildTrendContentKey(
      ...
      if (selectedContentType === 'result') {
        ...
        if (selectedResult) {
          ...
          caption = [
            ...
            `Source: ${source}`,
            'More fixtures and updates: www.bwinbetug.com',
          ]
            .filter(Boolean)
            .join('\n');
