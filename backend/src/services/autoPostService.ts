...
export class AutoPostService {
      ...
      const caption = this.normalizeXCaption(
        this.applyBwinBetTracking(
          [
            ...
            'Bet now: https://www.bwinbetug.com | More info: www.bwinbetug.info',
          ]
            .filter(Boolean)
            .join('\n'),
          emergencyOwnerId,
  ...
  private buildBwinTrackedBetUrl(ownerId: string, platform?: string) {
    ...
    if (!normalizedOwnerId) return 'https://www.bwinbetug.com';
    const baseUrl = this.getPublicBaseUrl();
    if (!baseUrl) return 'https://www.bwinbetug.com';
  ...
  private async createLeagueTableImageUrl(userId: string, snapshot: LeagueTableSnapshot) {
    ...
    try {
      ...
      await draftRef.set({
        ...
        cta: 'Bet: https://www.bwinbetug.com | Info: www.bwinbetug.info',
      ...
      if (selectedContentType === 'prediction') {
        ...
        if (picks.length) {
          ...
          caption = [
            ...
            picksLine,
            'Place your bet: https://www.bwinbetug.com | More info: www.bwinbetug.info',
          ]
            .filter(Boolean)
            .join('\n');
